...
const uint32_t TableStruct_RpcMessage_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::rpcDemo::RpcMessage, _impl_.type_),
  PROTOBUF_FIELD_OFFSET(::rpcDemo::RpcMessage, _impl_.id_),
  PROTOBUF_FIELD_OFFSET(::rpcDemo::RpcMessage, _impl_.serviceid_),
  PROTOBUF_FIELD_OFFSET(::rpcDemo::RpcMessage, _impl_.methodid_),
  PROTOBUF_FIELD_OFFSET(::rpcDemo::RpcMessage, _impl_.request_),
  PROTOBUF_FIELD_OFFSET(::rpcDemo::RpcMessage, _impl_.response_),
  PROTOBUF_FIELD_OFFSET(::rpcDemo::RpcMessage, _impl_.error_),
};
...
static const ::_pb::Message* const file_default_instances[] = {
  &::rpcDemo::_RpcMessage_default_instance_._instance,
};
...
const ::_pbi::DescriptorTable descriptor_table_RpcMessage_2eproto = {
    false, false, 402, descriptor_table_protodef_RpcMessage_2eproto,
    "RpcMessage.proto",
...
uint8_t* RpcMessage::_InternalSerialize(
  ...
  if (this->_internal_serviceid() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(3, this->_internal_serviceid(), target);
  }

  // uint32 methodId = 4;
  if (this->_internal_methodid() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(4, this->_internal_methodid(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:rpcDemo.RpcMessage)
  ...
  // uint32 methodId = 4;
  if (this->_internal_methodid() != 0) {
    total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(this->_internal_methodid());
  }
...
template<> PROTOBUF_NOINLINE ::rpcDemo::RpcMessage*
Arena::CreateMaybeMessage< ::rpcDemo::RpcMessage >(Arena* arena) {
